--  LLM.Tools — agent-control primitives and the tool descriptor type.
--
--  Defines the Abort_Flag and Pause_Flag protected types shared between
--  the agentic loop (LLM.Agent) and the shell tool executor
--  (LLM.Tools.Shell), together with the Tool_Descriptor record used to
