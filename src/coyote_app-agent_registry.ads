...
package Coyote_App.Agent_Registry is
   ...
   function Child_Count (R : Registry; Parent_Id : Agent_Id) return Natural;
   ...
   function Agent_At (R : Registry; Position : Positive) return Agent_Record;
   function Child_At
     (R : Registry; Parent_Id : Agent_Id; Position : Positive) return Agent_Id;
   function Get_Agent
     (R : Registry; Runtime_Id : Agent_Id) return Agent_Record;

   function Has_Agent (R : Registry; Runtime_Id : Agent_Id) return Boolean;
   ...
   function Can_Control (R : Registry; Runtime_Id : Agent_Id) return Boolean;
...
private
   ...
   package Agent_Vectors is new Ada.Containers.Vectors
     (Index_Type => Positive, Element_Type => Agent_Record);
