...
package Coyote_App.Agent_RPC.Transport is
   ...
   procedure Create_Listener (L : out Listener; Path : String);

   procedure Accept_Channel (L : in out Listener; C : out Channel);
   ...
   procedure Connect (C : out Channel; Path : String);
   ...
   procedure Create_Pair (Left : out Channel; Right : out Channel);
