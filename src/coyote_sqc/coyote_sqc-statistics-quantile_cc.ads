...
--    Two-stage bootstrap with B = 100 000 resamples per unique n_i.
...
--    two-sided tail α_B/2 = 0.00027; LCL at rank 27, UCL at rank 99 974.
...
package Coyote_SQC.Statistics.Quantile_CC is
   ...
   --  Bonferroni-adjusted alpha tail rank for B = 100 000.
   --  α = 0.0027 (3-sigma family-wise), α_B = α / 5 = 0.00054 per statistic.
   --  Two-sided tail: α_B / 2 = 0.00027.
   --  r = floor (0.00027 * 100 000) = 27.
   Bonferroni_Rank : constant Natural := 27;
   --  LCL_j = b_{(27)}; UCL_j = b_{(99 974)}; CL_j = b_{(50 000)}.
