...
package Coyote_SQC.Data_Model is
   ...
   package Tool_Call_Vectors is new Ada.Containers.Vectors
     (Index_Type => Positive, Element_Type => Tool_Call_Record);
   ...
   package Turn_Vectors is new Ada.Containers.Vectors
     (Index_Type => Positive, Element_Type => Turn_Record);
   ...
   package Session_Vectors is new Ada.Containers.Vectors
     (Index_Type => Positive, Element_Type => Session_Record);
   ...
   package Metrics_Vectors is new Ada.Containers.Vectors
     (Index_Type => Positive, Element_Type => Session_Metrics_Record);
   ...
   package Comment_Vectors is new Ada.Containers.Vectors
     (Index_Type => Positive, Element_Type => Comment_Record);
   ...
   type Plot_Method_Kind is
     (Classical,
      Robust_Median);

   type Estimation_Method_Kind is
     (Classical,
      Robust_Median);
