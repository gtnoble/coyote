...
package body Coyote_App.Headless is
   ...
   procedure Run
     (Opts     : Coyote_App.Options;
      ...
      procedure Poll_Control is
         Command : Coyote_App.Frontend.Control_Command;
      begin
         if not Coyote_App.Frontend.Has_Control_Channel (Frontend)
           or else not Coyote_App.Frontend.Read_Control (Frontend, Command)
         then
            return;
         end if;
         case Command.Kind is
            ...
            when Coyote_App.Frontend.Control_Pause =>
