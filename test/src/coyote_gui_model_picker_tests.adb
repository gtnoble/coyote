...
package body Coyote_GUI_Model_Picker_Tests is
   ...
   begin
      case Result.Status is
         ...
         when Selected
            | Use_Default =>
            Assert
              (False, "default picker result must represent cancellation");
      end case;
   ...
   begin
      case Result.Status is
         when Selected =>
            Assert
              (To_String (Result.Model_Spec) = "openai/test-model",
   ...
   begin
      case Result.Status is
         ...
         when Cancelled
            | Selected =>
            Assert
              (False, "default result must represent the fallback choice");
      end case;
