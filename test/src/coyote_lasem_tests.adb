...
package body Coyote_Lasem_Tests is
   ...
   begin
      Error :=
        Coyote_Lasem.Measure_MathML
          (C_Source,
           Interfaces.C.long (Source'Length),
           Width'Access,
           Height'Access,
           Baseline'Access);
      Assert
        (Error = Interfaces.C.Strings.Null_Ptr,
   ...
   begin
      ...
      Assert (Width > 0 and then Height > 0, "matrix dimensions are non-zero");
   ...
   begin
      ...
      Assert
        (Width_2 > Width_1 and then Height_2 > Height_1,
         "Lasem dimensions increase at scale 2");
      Assert (Base_2 > Base_1, "Lasem baseline increases at scale 2");
   ...
   begin
      ...
      Assert
        (Width > 0 and then Height > 0, "relation dimensions are non-zero");
   ...
   package Coyote_Lasem_Caller is new AUnit.Test_Caller
     (Coyote_Lasem_Tests.Test);
