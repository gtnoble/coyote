...
package body Coyote_GUI_Navigation_Tests is
   ...
   begin
      Assert
        (Target_Value (10.0, 0.0, 1_000.0, 100.0, 18.0, Line_Down) = 28.0,
         "line down should advance by line size");
      Assert
        (Target_Value (10.0, 0.0, 1_000.0, 100.0, 18.0, Line_Up) = 0.0,
   ...
   begin
      Assert
        (Target_Value (300.0, 0.0, 1_000.0, 100.0, 18.0, Page_Down) = 400.0,
         "page down should advance by page size");
      Assert
        (Target_Value (300.0, 0.0, 1_000.0, 100.0, 18.0, Page_Up) = 200.0,
   ...
   begin
      Assert
        (Target_Value (300.0, 0.0, 1_000.0, 100.0, 18.0, To_Top) = 0.0,
         "top should select lower bound");
      Assert
        (Target_Value (0.0, 0.0, 1_000.0, 100.0, 18.0, To_Bottom) = 900.0,
         "bottom should account for page size");
      Assert
        (Target_Value (1_000.0, 0.0, 1_000.0, 100.0, 18.0, Line_Down) = 900.0,
         "down should clamp at effective upper bound");
   end Test_Top_Bottom_And_Clamp;

   package Coyote_GUI_Navigation_Caller is new AUnit.Test_Caller
     (Coyote_GUI_Navigation_Tests.Test);
   ...
   begin
      Result.Add_Test
        (Coyote_GUI_Navigation_Caller.Create
