...
package body Coyote_App_Tests is
   ...
   begin
      ...
      Assert
        (S.Current_Model = "anthropic/claude-3-5-sonnet",
         "Model should be updated");
      S.Set_Model ("openai/gpt-4o");
      Assert
        (S.Current_Model = "openai/gpt-4o", "Model should be overwritten");
   ...
   begin
      ...
      Assert (S.Is_Streaming, "Should be streaming after Set_Streaming(True)");
   ...
   begin
      ...
      Assert (Nth_Field ("a  b", 2) = "b", "Multiple spaces between fields");
      Assert (Nth_Field ("single", 1) = "single", "Single token, N=1");
      Assert (Nth_Field ("single", 2) = "", "Single token, N=2");
   ...
   procedure Test_Nth_Field_Tabs (T : in out Test) is
      ...
      Line : constant String :=
        "amazon-bedrock" & ASCII.HT & "amazon.nova-lite-v1:0" & ASCII.HT
        & "300K";
   begin
   ...
   begin
      ...
      Assert (S.Turn_Step = 1, "After one increment Turn_Step should be 1");
      S.Increment_Turn_Step;
      S.Increment_Turn_Step;
      Assert (S.Turn_Step = 3, "After three increments Turn_Step should be 3");
   ...
   begin
      S.Set_Turn_Step (5);
      Assert (S.Turn_Step = 5, "Set_Turn_Step should store the given value");
   ...
   begin
      S.Set_Turn_Step (5);
      S.Reset_Turn_Step;
      Assert (S.Turn_Step = 0, "Reset_Turn_Step should return to 0");
   ...
   begin
      ...
      Assert (S.Turn_Count = 1, "After one increment Turn_Count should be 1");
      S.Increment_Turn_Count;
      S.Increment_Turn_Count;
      Assert
        (S.Turn_Count = 3, "After three increments Turn_Count should be 3");
   ...
   begin
      S.Set_Turn_Count (42);
      Assert
        (S.Turn_Count = 42, "Set_Turn_Count should store the given value");
      S.Set_Turn_Count (0);
   ...
   procedure Test_State_Is_Retrying_Initial (T : in out Test) is
      ...
      S : App_State;
   begin
      Assert (not S.Is_Retrying, "Is_Retrying should be False initially");
   ...
   begin
      ...
      Assert
        (S.Is_Retrying, "Is_Retrying must remain True after Set_Text_Emitted");
   ...
   begin
      Assert
        (not S.Has_Text_Delta, "Has_Text_Delta should be False initially");
   ...
   procedure Test_State_Pending_Stats_Gated_By_Stop_Reason (T : in out Test) is
      pragma Unreferenced (T);
      S : App_State;
   ...
   begin
      ...
      Assert
        (S.Last_Error_Message = "context length exceeded",
      ...
      Assert
        (S.Last_Error_Message = "rate limit exceeded",
   ...
   procedure Test_State_Turn_Cost_Initial (T : in out Test) is
      ...
      S : App_State;
   begin
      Assert (S.Turn_Cost_Dmil = 0, "Turn_Cost_Dmil should be 0 initially");
   ...
   begin
      S.Set_Session_Stats
        (Cost_Dmil   => 4_321,
         ...
         Cache_Write => 5_000,
         Total       => 187_500);
      Assert (S.Session_Cost_Dmil = 4_321, "Session_Cost_Dmil should be 4321");
      Assert
        (S.Session_Input_Tokens = 100_000,
         "Session_Input_Tokens should be 100000");
      Assert
        (S.Session_Output_Tokens = 2_500,
         "Session_Output_Tokens should be 2500");
      Assert
        (S.Session_Cache_Read = 80_000, "Session_Cache_Read should be 80000");
      Assert
        (S.Session_Cache_Write = 5_000, "Session_Cache_Write should be 5000");
      Assert
        (S.Session_Total_Tokens = 187_500,
   ...
   begin
      ...
      S.Set_Turn_Cost (234);
      Assert
        (S.Turn_Input_Tokens = 12_000,
         "Turn_Input_Tokens unchanged after Set_Turn_Cost");
      Assert
        (S.Turn_Output_Tokens = 400,
         "Turn_Output_Tokens unchanged after Set_Turn_Cost");
      Assert (S.Turn_Cost_Dmil = 234, "Turn_Cost_Dmil set correctly");
      ...
      Assert
        (S.Session_Cost_Dmil = 999, "Session_Cost_Dmil set independently");
   ...
   begin
      Assert
        (JSON_Scalar_Image (V) = "hello world",
   ...
   begin
      Assert
        (Result'Length > 0, "Float value should produce a non-empty string");
      --  Must not be the fallback sentinel.
      Assert (Result /= "...", "Float value should not produce ""...""");
   ...
   begin
      ...
      Assert
        (JSON_Scalar_Image (V) = "...", "Object value should return ""...""");
   ...
   begin
      ...
      V := Create (Arr);
      Assert
        (JSON_Scalar_Image (V) = "...", "Array value should return ""...""");
   ...
   begin
      ...
      Assert
        (S.One_Shot_Result = "{""output"":""hello""}",
   ...
   procedure Test_Format_Tool_Field_Single_Line (T : in out Test) is
      pragma Unreferenced (T);
      Result : constant String := Format_Tool_Field ("command", "echo hello");
   begin
      Assert
        (Result = UC_Box_V & " command: echo hello",
   ...
   procedure Test_Format_Tool_Field_Two_Lines (T : in out Test) is
      ...
      Result : constant String := Format_Tool_Field ("command", Value);
      Expect : constant String :=
        UC_Box_V & " command: echo a" & ASCII.LF & UC_Box_V & " echo b";
   begin
      Assert (Result = Expect, "Two-line field: got """ & Result & """");
   ...
   procedure Test_Format_Tool_Field_Three_Lines (T : in out Test) is
      ...
      Value  : constant String :=
        "cd /tmp" & ASCII.LF & "echo a" & ASCII.LF & "echo b";
      Result : constant String := Format_Tool_Field ("command", Value);
      Expect : constant String :=
        UC_Box_V & " command: cd /tmp" & ASCII.LF & UC_Box_V & " echo a"
        & ASCII.LF & UC_Box_V & " echo b";
   begin
      Assert (Result = Expect, "Three-line field: got """ & Result & """");
   ...
   procedure Test_Format_Tool_Field_Trailing_LF (T : in out Test) is
      ...
      Result : constant String := Format_Tool_Field ("k", Value);
      Expect : constant String :=
        UC_Box_V & " k: hello" & ASCII.LF & UC_Box_V & " ";
   begin
      Assert (Result = Expect, "Trailing-LF field: got """ & Result & """");
   ...
   procedure Test_Format_Tool_Field_Empty_Value (T : in out Test) is
      pragma Unreferenced (T);
      Result : constant String := Format_Tool_Field ("key", "");
   begin
      Assert
        (Result = UC_Box_V & " key: ",
         "Empty-value field should be ""box-v key: ""; " & "got """ & Result
         & """");
   ...
   procedure Test_Format_Tool_Field_Truncation (T : in out Test) is
      ...
      Result : constant String := Format_Tool_Field ("k", Value, Max_Len => 8);
      Expect : constant String := UC_Box_V & " k: abcde" & UC_Ellip;
   begin
      Assert
        (Result = Expect,
         "Truncated field should end with ellipsis; " & "got """ & Result
         & """");
   ...
   procedure Test_Tool_Segment_Line_Count (T : in out Test) is
      ...
      Single : constant String := Format_Tool_Field ("command", "echo hello");
      NL_Single : Natural         := 0;
   ...
   procedure Test_Format_Cost_Zero (T : in out Test) is
      pragma Unreferenced (T);
   begin
      Assert (Format_Cost (0) = "$0.0000", "0 dmil -> ""$0.0000""");
   ...
   begin
      ...
      Assert (Format_Cost (9_999) = "$0.9999", "9999 dmil -> ""$0.9999""");
   ...
   procedure Test_Format_Cost_Dollars (T : in out Test) is
      pragma Unreferenced (T);
   begin
      Assert (Format_Cost (10_000) = "$1.0000", "10000 dmil -> ""$1.0000""");
      Assert (Format_Cost (12_345) = "$1.2345", "12345 dmil -> ""$1.2345""");
      Assert
        (Format_Cost (100_000) = "$10.0000", "100000 dmil -> ""$10.0000""");
   ...
   begin
      ...
      Assert (Get_Cost_Dmil (Val, "cost") = 10, "Float 0.001 -> 10 dmil");
   ...
   begin
      ...
      Assert (Get_Cost_Dmil (Val, "cost") = 0, "Float 0.0 -> 0 dmil");
   ...
   begin
      ...
      Assert (Get_Cost_Dmil (Val, "cost") = 0, "Integer 0 -> 0 dmil");
   ...
   begin
      Assert (Get_Cost_Dmil (Val, "cost") = 0, "Absent field -> 0 dmil");
   ...
   begin
      Val.Set_Field ("cost", Create (Long_Float (-0.001)));
      Assert (Get_Cost_Dmil (Val, "cost") = 0, "Negative float -> 0 dmil");
   ...
   begin
      Assert
        (Format_Status (S, "ready") = UC_BULLET & " ready",
   ...
   begin
      Assert
        (Format_Status (S, "running") = UC_BULLET & " running",
   ...
   begin
      ...
      Assert
        (Status_Contains (Format_Status (S), " [anthropic/claude-3-5]"),
   ...
   begin
      ...
      Assert
        (Status_Contains (Format_Status (S), " session:abcdef01"),
   ...
   begin
      ...
      Assert
        (Status_Contains (Format_Status (S), " ~medium"),
   ...
   begin
      ...
      Assert
        (Status_Contains (Format_Status (S, "running"), " [restricted]"),
   ...
   procedure Test_Format_Model_Price_In_Out_Only (T : in out Test) is
      pragma Unreferenced (T);
      Result : constant String := Format_Model_Price (3.0, 15.0, 0.0, 0.0);
   begin
      Assert
        (Result = "in $3" & UC_MICRO & " out $15" & UC_MICRO & " /tok",
         "in/out-only prices should produce SI µ segments" & " but got """
         & Result & """");
   end Test_Format_Model_Price_In_Out_Only;

   procedure Test_Format_Model_Price_All_Four (T : in out Test) is
      pragma Unreferenced (T);
      Result : constant String := Format_Model_Price (3.0, 15.0, 0.3, 4.0);
   begin
      Assert
        (Result
         = "in $3" & UC_MICRO & " out $15" & UC_MICRO & " cr $300n" & " cw $4"
         & UC_MICRO & " /tok",
   ...
   procedure Test_Format_Model_Price_Omits_Zeros (T : in out Test) is
      pragma Unreferenced (T);
      Result : constant String := Format_Model_Price (2.5, 10.0, 0.0, 0.0);
   begin
      Assert
        (Ada.Strings.Unbounded.Index (To_Unbounded_String (Result), "cr") = 0,
         "Zero cache_read should not produce a ""cr"" label");
      Assert
        (Ada.Strings.Unbounded.Index (To_Unbounded_String (Result), "cw") = 0,
         "Zero cache_write should not produce a ""cw"" label");
      Assert
        (Ada.Strings.Unbounded.Index (To_Unbounded_String (Result), "/tok")
         > 0,
   ...
   procedure Test_Format_Model_Price_Cache_Only (T : in out Test) is
      pragma Unreferenced (T);
      Result : constant String := Format_Model_Price (0.0, 0.0, 0.3, 0.0);
   begin
      Assert
        (Result = "cr $300n /tok",
   ...
   begin
      Assert
        (Format_DB_Price (1_000_000.0) = "0",
         "one dollar per token should be 0 dB");
      Assert
        (Format_DB_Price (3.0) = "-55.23",
         "3 dollars per MTok should convert to -55.23 dB");
      Assert
        (Format_DB_Price (15.0) = "-48.24",
   ...
   begin
      Assert
        (Format_DB_Price (0.0) = "free", "zero price should display as free");
      Assert
        (Format_DB_Price (-1.0) = "",
   ...
   begin
      ...
      Assert
        (Ada.Strings.Unbounded.Length (Warn) = 0,
   ...
   procedure Test_Apply_Filter_Echo (T : in out Test) is
      pragma Unreferenced (T);
      Warn   : Ada.Strings.Unbounded.Unbounded_String;
      Result : constant String := Apply_Prompt_Filter ("hello", "cat", Warn);
   begin
      Assert
        (Result = "hello",
         "cat filter should echo the prompt back; got """ & Result & """");
      Assert
        (Ada.Strings.Unbounded.Length (Warn) = 0,
   ...
   begin
      Assert
        (Result = "HELLO",
         "tr filter should uppercase the prompt; got """ & Result & """");
      Assert
        (Ada.Strings.Unbounded.Length (Warn) = 0,
         "Successful filter should leave Warn_Buf empty");
   ...
   begin
      Assert
        (Result = "hello", "Non-zero-exit filter should return raw prompt");
      Assert
        (Ada.Strings.Unbounded.Length (Warn) > 0,
   ...
   begin
      Assert
        (Result = "hello", "Empty-output filter should return raw prompt");
      Assert
        (Ada.Strings.Unbounded.Length (Warn) > 0,
   ...
   procedure Test_Apply_Filter_Trims_Whitespace (T : in out Test) is
      ...
      Result : constant String :=
        Apply_Prompt_Filter ("x", "printf '  trimmed  '", Warn);
   begin
      Assert
        (Result = "trimmed",
   ...
   procedure Test_State_Prompt_Filter_Initial (T : in out Test) is
      ...
      S : App_State;
   begin
      Assert (S.Prompt_Filter = "", "Prompt_Filter should be empty initially");
   ...
   begin
      ...
      Assert
        (S.Prompt_Filter = "m4 -", "Prompt_Filter should return stored value");
      S.Set_Prompt_Filter ("");
      Assert
        (S.Prompt_Filter = "", "Prompt_Filter should update to empty string");
   ...
   begin
      Assert
        (not S.Is_Pause_Armed, "Is_Pause_Armed should be False initially");
   ...
   begin
      Assert
        (S.Current_Sandbox = "", "Current_Sandbox should be empty initially");
   ...
   begin
      Doc :=
        Coyote_Cmark.Parse_Document
          (C_Text, size_t (Table_MD'Length), Coyote_Cmark.OPT_DEFAULT);
      Assert
        (Doc /= System.Null_Address,
   ...
   begin
      Doc :=
        Coyote_Cmark.Parse_Document
          (C_Text, size_t (Para_MD'Length), Coyote_Cmark.OPT_DEFAULT);
      Assert
        (Doc /= System.Null_Address,
         "Parse_Document must return a non-null document node");
   ...
   package App_State_Caller is new AUnit.Test_Caller (Coyote_App_Tests.Test);
      ...
      Result.Add_Test
        (App_State_Caller.Create
           ("App_State Last_Error_Message round-trip and independence",
            Coyote_App_Tests.Test_State_Last_Error_Message_Round_Trip'Access));
      Result.Add_Test
        (App_State_Caller.Create
           ("App_State Pending_Stats gated by Last_Stop_Reason "
            & "(stop/length only)",
            Coyote_App_Tests.Test_State_Pending_Stats_Gated_By_Stop_Reason'
              Access));
      Result.Add_Test
        (App_State_Caller.Create
