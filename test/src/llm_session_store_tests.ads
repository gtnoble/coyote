...
package LLM_Session_Store_Tests is
   ...
   procedure Test_Assistant_Thinking_Text_Round_Trip (T : in out Test);
   ...
   procedure Test_Load_Without_Compaction_Unchanged (T : in out Test);
   ...
   procedure Test_Assistant_Tool_Call_Invalid_Args (T : in out Test);
