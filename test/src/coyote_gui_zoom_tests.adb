...
package body Coyote_GUI_Zoom_Tests is
   ...
   begin
      Assert
        (Effective_Size_Pt (3, Base) = Base + 3 * Zoom_Step_Pt,
   ...
   begin
      Assert
        (Effective_Size_Pt (1_000, Base) = Max_Size_Pt,
   ...
   begin
      Assert
        (Effective_Size_Pt (-1_000, Base) = Min_Size_Pt,
   ...
   begin
      ...
      Assert
        (Effective_Size_Pt (Level, Base) = Max_Size_Pt,
   ...
   begin
      ...
      Assert
        (Effective_Size_Pt (Level, Base) = Min_Size_Pt,
   ...
   begin
      ...
      Assert
        (Level <= (Max_Size_Pt - Min_Size_Pt) / Zoom_Step_Pt + 1,
   ...
   begin
      ...
      Assert
        (Clamped_Base_Pt (2) = Min_Size_Pt,
         "tiny baseline clamps to Min_Size_Pt");
      Assert
        (Clamped_Base_Pt (100) = Max_Size_Pt,
         "huge baseline clamps to Max_Size_Pt");
   end Test_Clamped_Base_Pt;

   package Coyote_GUI_Zoom_Caller is new AUnit.Test_Caller
     (Coyote_GUI_Zoom_Tests.Test);
      ...
      Result.Add_Test
        (Coyote_GUI_Zoom_Caller.Create
           ("Coyote.GUI.Zoom step zoom at max reports no change",
            Coyote_GUI_Zoom_Tests.Test_Step_Zoom_At_Max_Reports_No_Change'
              Access));
      Result.Add_Test
        (Coyote_GUI_Zoom_Caller.Create
           ("Coyote.GUI.Zoom step zoom at min reports no change",
            Coyote_GUI_Zoom_Tests.Test_Step_Zoom_At_Min_Reports_No_Change'
              Access));
      Result.Add_Test
        (Coyote_GUI_Zoom_Caller.Create
      ...
      Result.Add_Test
        (Coyote_GUI_Zoom_Caller.Create
           ("Coyote.GUI.Zoom step zoom stops at the clamp",
            Coyote_GUI_Zoom_Tests.Test_Step_Zoom_Multi_Step_Stops_At_Clamp'
              Access));
      Result.Add_Test
        (Coyote_GUI_Zoom_Caller.Create
