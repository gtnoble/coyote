...
package Subagent_Integration_Tests is
   ...
   procedure Test_One_Shot_Returns_Json (T : in out Test);
   ...
   procedure Test_One_Shot_Fresh_Session_Each_Run (T : in out Test);
   ...
   procedure Test_One_Shot_Prompt_Failure_Has_Session_Id (T : in out Test);
