...
begin
   Run
     ("Test_Single_Turn_Prompt",
      LLM_Agent_Tests.Test_Single_Turn_Prompt'Access);
   Run ("Test_Tool_Call_Loop", LLM_Agent_Tests.Test_Tool_Call_Loop'Access);
   Run
     ("Test_Two_Tool_Call_Loop",
   ...
   Run
     ("Test_Switch_Session_Loads_History",
      LLM_Agent_Tests.Test_Switch_Session_Loads_History'Access);
   Run ("Test_Abort_Request", LLM_Agent_Tests.Test_Abort_Request'Access);
   Run
     ("Test_Abort_Batched_Tools_Keep_History_Valid",
      LLM_Agent_Tests.Test_Abort_Batched_Tools_Keep_History_Valid'Access);
   Run
     ("Test_Abort_During_Shell_With_Timeout",
      LLM_Agent_Tests.Test_Abort_During_Shell_With_Timeout'Access);
   Run
     ("Test_Session_File_Written_Only_After_Turn_End",
