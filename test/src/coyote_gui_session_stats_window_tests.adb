...
package body Coyote_GUI_Session_Stats_Window_Tests is
   ...
   begin
      ...
      Assert (Got.Turn_Count = Want.Turn_Count, "turn count must be retained");
      Assert (Got.Last_Input = Want.Last_Input, "last input must be retained");
      Assert
        (Got.Last_Output = Want.Last_Output, "last output must be retained");
      Assert
        (Got.Last_Cost_Dmil = Want.Last_Cost_Dmil,
      ...
      Assert (Got.Cost_Dmil = Want.Cost_Dmil, "cost total must be retained");
   ...
   begin
      ...
      Coyote_GUI.Session_Stats_Window.Create (Window, Parent.all'Access);
      Assert
        (Coyote_GUI.Session_Stats_Window.Is_Created (Window),
   ...
   package Coyote_GUI_Session_Stats_Window_Caller is new AUnit.Test_Caller
     (Coyote_GUI_Session_Stats_Window_Tests.Test);
   ...
   begin
      Result.Add_Test
        (Coyote_GUI_Session_Stats_Window_Caller.Create
           ("Coyote.GUI session stats snapshot round trip",
            Coyote_GUI_Session_Stats_Window_Tests.Test_Snapshot_Round_Trip'
              Access));
      Result.Add_Test
        (Coyote_GUI_Session_Stats_Window_Caller.Create
           ("Coyote.GUI session stats clear resets snapshot",
            Coyote_GUI_Session_Stats_Window_Tests.Test_Clear_Resets_Snapshot'
              Access));
      Result.Add_Test
        (Coyote_GUI_Session_Stats_Window_Caller.Create
           ("Coyote.GUI session stats window creation is idempotent",
            Coyote_GUI_Session_Stats_Window_Tests.Test_Create_Is_Idempotent'
              Access));
