...
package LLM_System_Prompt_Tests is
   ...
   procedure Test_Custom_Prompt_Replaces_Preamble (T : in out Test);
   procedure Test_Custom_Prompt_Keeps_Cwd (T : in out Test);
   procedure Test_Append_Prompt_Appears (T : in out Test);
