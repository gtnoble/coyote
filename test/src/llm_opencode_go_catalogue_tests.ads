...
package LLM_OpenCode_Go_Catalogue_Tests is
   ...
   --  Verify that documented Responses models get the Responses wire format.
   procedure Test_Wire_Format_Responses (T : in out Test);
   ...
   --  Verify that OpenCode Go Responses requests use the Responses wire.
   procedure Test_Responses_Request_Uses_Responses_Wire (T : in out Test);
