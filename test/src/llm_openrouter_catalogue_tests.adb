...
package body LLM_OpenRouter_Catalogue_Tests is
   ...
   begin
      ...
      Ensure_Test_Home (Home);
      Write_Cache
        (Home => Home, Fetched_At => 0, Data_Array => Stale_Data_Array);
   ...
   begin
      ...
      Ensure_Test_Home (Home);
      Write_Cache
        (Home => Home, Fetched_At => 0, Data_Array => Fixture_Data_Array);
   ...
   package LLM_OpenRouter_Catalogue_Caller is new AUnit.Test_Caller
     (LLM_OpenRouter_Catalogue_Tests.Test);
   ...
   begin
      Result.Add_Test
        (LLM_OpenRouter_Catalogue_Caller.Create
        ...
        (LLM_OpenRouter_Catalogue_Caller.Create
           ("LLM.OpenRouter.Catalogue uses live fetch when the cache is stale",
            LLM_OpenRouter_Catalogue_Tests
              .Test_Stale_Cache_Triggers_Live_Fetch'
              Access));
      Result.Add_Test
        (LLM_OpenRouter_Catalogue_Caller.Create
