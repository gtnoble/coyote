...
package body Coyote_SQC_Integrity_Tests is
   ...
   begin
      ...
      Assert
        (W.Setup_Session_Ids.Contains (To_Unbounded_String ("aaa")),
         "Remove_Missing partial: ""aaa"" must be retained");
      Assert
        (W.Setup_Session_Ids.Contains (To_Unbounded_String ("bbb")),
      ...
      Assert
        (Natural (W.Setup_Session_Ids.Length) = 2,
   ...
   package SQC_Integrity_Caller is new AUnit.Test_Caller
     (Coyote_SQC_Integrity_Tests.Test);
