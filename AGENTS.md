...
current code or documentation. The current registered test baseline is 862.
...
The complete development suite currently contains 862 registered tests and
passes 862/862 in approximately 36 seconds on the development host. The
